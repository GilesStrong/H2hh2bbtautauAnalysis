					...
					// fill covmatrix histos:
						...
						if (runOnSignal) {
							...
							if (getGenParticles(genParticles, &gen_hBB_key, &gen_hTauTau_key)) { //If both Higgs found
								...
								const reco::GenParticle gen_bjet0 = &gen_hBB.daughter(0);
								const reco::GenParticle gen_bjet1 = &gen_hBB.daughter(1);
								const reco::GenParticle gen_tau0 = &gen_hTauTau.daughter(0);
								const reco::GenParticle gen_tau1 = &gen_hTauTau.daughter(1);
